...
using Luke.IBatisNet.DataAccess.Configuration.Serializers;
using Luke.IBatisNet.DataAccess.Interfaces;
using Luke.IBatisNet.DataAccess.Scope;

#endregion

namespace Luke.IBatisNet.DataAccess.Configuration
{
	/// <summary>
