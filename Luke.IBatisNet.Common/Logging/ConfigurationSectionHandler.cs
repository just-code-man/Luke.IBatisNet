...
using System.Xml;
using Luke.IBatisNet.Common.Logging.Impl;
using ConfigurationException = Luke.IBatisNet.Common.Exceptions.ConfigurationException;

namespace Luke.IBatisNet.Common.Logging
{
	/// <summary>
	...
	///				<section name="logging" type="IBatisNet.Common.Logging.ConfigurationSectionHandler, Luke.IBatisNet.Common" />
	///			</sectionGroup>	
	///		</configSections>
	///		<iBATIS>
	///			<logging>
	///				<logFactoryAdapter type="IBatisNet.Common.Logging.Impl.ConsoleOutLoggerFA, Luke.IBatisNet.Common">
	...
	/// </para>
	/// <list type="table">
	/// <item><term>CONSOLE</term><description>Alias for Luke.IBatisNet.Common.Logging.Impl.ConsoleOutLoggerFA, Luke.IBatisNet.Common</description></item>
	/// <item><term>TRACE</term><description>Alias for Luke.IBatisNet.Common.Logging.Impl.TraceLoggerFA, Luke.IBatisNet.Common</description></item>
	/// <item><term>NOOP</term><description>Alias Luke.IBatisNet.Common.Logging.Impl.NoOpLoggerFA, Luke.IBatisNet.Common</description></item>
	/// </list>
	/// </remarks>
