...
using Luke.IBatisNet.Common.Xml;
using Luke.IBatisNet.DataMapper.Configuration.Alias;
using Luke.IBatisNet.DataMapper.Configuration.Cache;
using Luke.IBatisNet.DataMapper.Configuration.Cache.Fifo;
using Luke.IBatisNet.DataMapper.Configuration.Cache.Lru;
using Luke.IBatisNet.DataMapper.Configuration.Cache.Memory;
...
using Luke.IBatisNet.DataMapper.Configuration.Serializers;
using Luke.IBatisNet.DataMapper.Configuration.Sql;
using Luke.IBatisNet.DataMapper.Configuration.Sql.Dynamic;
using Luke.IBatisNet.DataMapper.Configuration.Sql.Dynamic.Elements;
using Luke.IBatisNet.DataMapper.Configuration.Sql.SimpleDynamic;
using Luke.IBatisNet.DataMapper.Configuration.Sql.Static;
using Luke.IBatisNet.DataMapper.Configuration.Statements;
using Luke.IBatisNet.DataMapper.MappedStatements;
using Luke.IBatisNet.DataMapper.MappedStatements.ArgumentStrategy;
...
namespace Luke.IBatisNet.DataMapper.Configuration
{
    /// <summary>
    ...
    public class DomSqlMapBuilder
    {
        ...
        {
            return Assembly.GetExecutingAssembly().GetManifestResourceStream("Luke.IBatisNet.DataMapper." + schemaResourceKey); 
        }
