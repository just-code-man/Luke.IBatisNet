...
namespace Luke.IBatisNet.DataMapper.Configuration.Serializers
{
	/// <summary>
	...
	public sealed class InsertDeSerializer
	{
		...
		private static SelectKeyType ReadSelectKeyType(string s) 
		{
			switch (s) 
			{
				case @"pre": return Luke.IBatisNet.DataMapper.SelectKeyType.@pre;
				case @"post": return Luke.IBatisNet.DataMapper.SelectKeyType.@post;
