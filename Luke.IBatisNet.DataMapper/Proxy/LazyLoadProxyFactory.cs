...
namespace Luke.IBatisNet.DataMapper.Proxy
{
    /// <summary>
    /// Proxy Factory for Lazy Load
    /// </summary>
    public class LazyLoadProxyFactory : ILazyFactory
    {
            ...
            object target, ISetAccessor setAccessor)
        {
            ...
            // Build the proxy
            var interceptor = new LazyLoadInterceptor(selectStatement.SqlMap, selectStatement, param, target, setAccessor);
